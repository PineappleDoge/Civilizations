--------------------------------------------------------
-- PineappleDoge1 | Gold Storage
-- 6-30-2021 | Prototype
-- Gold Storage data
--------------------------------------------------------
-- Module Setup
local GoldStorage = {
	Description = "Holds all gold resources.";
	CostType = "Souls";
...
--------------------------------------------------------
-- Private Functions
GoldStorage.Name = "Gold Storage"
GoldStorage.UpgradeCost = UpgradeCost
GoldStorage.UpgradeTime = UpgradeTime
