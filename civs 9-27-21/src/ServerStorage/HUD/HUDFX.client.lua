...
local function ButtonClick(obj, x, y)
	...
	if obj.Name == "Build" then
		spr.target(frame.Parent.Build.CutoutFrame.MainFrame.ExtraFrame, 0.85, 4.5, {Position = UDim2.new(0,0,0,0)})
		task.delay(1.5, function()
			spr.stop(frame.Parent.Build.CutoutFrame.MainFrame.ExtraFrame)	
		end)
	end
end
