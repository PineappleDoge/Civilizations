...
local OnMessageDoneFiltering = ChatEvents:WaitForChild("OnMessageDoneFiltering", math.huge)
local OnNewMessage = ChatEvents:WaitForChild("OnNewMessage", math.huge)
