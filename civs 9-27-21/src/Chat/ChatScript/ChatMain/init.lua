...
local DefaultChatSystemChatEvents = ReplicatedStorage:WaitForChild("DefaultChatSystemChatEvents", math.huge)
local EventFolder = ReplicatedStorage:WaitForChild("DefaultChatSystemChatEvents", math.huge)
local clientChatModules = Chat:WaitForChild("ClientChatModules", math.huge)
local ChatConstants = require(clientChatModules:WaitForChild("ChatConstants", math.huge))
local ChatSettings = require(clientChatModules:WaitForChild("ChatSettings", math.huge))
local messageCreatorModules = clientChatModules:WaitForChild("MessageCreatorModules", math.huge)
local MessageCreatorUtil = require(messageCreatorModules:WaitForChild("Util", math.huge))
