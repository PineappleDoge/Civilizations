...
do
	local rotation = 0
	for i = 1, 4 do
		local Arrow = REPLICATED_SERVICE.Shared.Assets.Arrow:Clone()
		Arrow.PrimaryPart.Anchored = true
		Arrow:SetPrimaryPartCFrame(Arrow:GetPrimaryPartCFrame() * CFrame.Angles(math.pi/2, rotation, 0))
		Arrow:SetPrimaryPartCFrame(workspace['1x1']:GetPrimaryPartCFrame())
