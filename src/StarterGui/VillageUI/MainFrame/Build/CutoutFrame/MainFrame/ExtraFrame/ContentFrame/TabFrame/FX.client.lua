...
local function ButtonClick(obj, x, y)
	...
	if obj:GetAttribute("On") == false then
		...
		if name == "ArmyFrame" then
			...
			Tween(frame.Parent.ResourcesFrame, {Position = UDim2.new(2.044,0,0.071,0)},0.5)
		...
		if name == "DefenseFrame" then
			...
			Tween(frame.Parent.ResourcesFrame, {Position = UDim2.new(1.044,0,0.071,0)},0.5)
			Tween(frame.Parent.TrapsFrame, {Position = UDim2.new(2.044,0,0.071,0)},0.5)
		end
		
		if name == "ResourcesFrame" then
			...
			Tween(frame.Parent.ResourcesFrame, {Position = UDim2.new(0.044,0,0.071,0)},0.5)
		...
		if name == "TrapsFrame" then
			...
			Tween(frame.Parent.ResourcesFrame, {Position = UDim2.new(-1,0,0.071,0)},0.5)
